...
let HospitalsController = class HospitalsController {
    constructor(http, hospitalsService) {
        this.http = http;
        this.hospitalsService = hospitalsService;
    }
    async getUsersConfluence(request) {
...
], HospitalsController.prototype, "getUsersConfluence", null);
HospitalsController = __decorate([
    common_1.Controller('hospitals'),
    __metadata("design:paramtypes", [common_1.HttpService, hospitals_service_1.HospitalsService])
], HospitalsController);
